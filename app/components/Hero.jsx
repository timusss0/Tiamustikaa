...
const item = {
  ...
  return (
    ...
    initial="hidden"
    animate="show"
    id="/" className="max-w-2xl md:mb-46 m-auto flex flex-col md:items-center md:justify-center lg:justify-center text-center lg:items-center pb-50 overflow-hidden">  
        <CursorProvider>
        <Cursor />
        ...
        <motion.div variants={item}>
            ...
            <motion.h3 
            variants={item}className="text-lg md:text-xl font-semibold flex items-center justify-center gap-2">I'm Tia Mustika</motion.h3>
            <motion.h1 variants={item} className="text-3xl md:text-5xl font-semibold mt-3 leading-tight">Fullstack Developer</motion.h1>
