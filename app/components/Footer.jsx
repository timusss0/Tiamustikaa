...
export const Footer = () => {
  ...
  return (
    <div>
   <footer className="w-screen relative left-1/2 right-1/2 -translate-x-1/2 py-12 px-4 text-center backdrop-blur-xl shadow-md bg-gradient-to-b from-pink-300/30 via-purple-600/30 to-blue-200/30">
